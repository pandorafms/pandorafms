...
# Enterprise console
rpmbuild -ba $CODEHOME_ENT/pandora/branches/3.2/pandora_console/enterprise/pandora_console_enterprise.spec || exit 1

# Enterprise server
rpmbuild -ba $CODEHOME_ENT/pandora/branches/3.2/pandora_server/PandoraFMS-Enterprise/pandora_server_enterprise.spec || exit 1
