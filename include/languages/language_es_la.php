...
<br><br>
El tamaño de la Base de Datos aumentará de manera lineal. Utilizamos un método de compactación para reducir el número de eventos almacenados en la base de datos sin perder la información necesaria. Esta compactación se produce cada cierto tiempo (configurable)."; 
...
Eliminar datos falsos, incorrectos o simplemente molestos permite que la escala de las gráficas sea más «real»
...
Por ejemplo, en un tipo de módulo que registra número de procesos, nos interesan valores entre 0 y 100,
puede que tengamos valores muy por encima de 100, pero generalmente serán errores, ruido o situaciones especiales.
Podemos incluir como mínimo un 0, y como máximo un 100.
...
$lang_label["incident_user"]="Autores de los indicentes";
