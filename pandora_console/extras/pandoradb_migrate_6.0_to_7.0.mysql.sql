...
ALTER TABLE `tmetaconsole_event` ADD INDEX `tmetaconsole_event_timestamp_idx` (`timestamp`) ALGORITHM DEFAULT LOCK DEFAULT;
ALTER TABLE `tmetaconsole_event` ADD INDEX `tmetaconsole_event_module_status_idx` (`module_status`) ALGORITHM DEFAULT LOCK DEFAULT;
ALTER TABLE `tmetaconsole_event` ADD INDEX `tmetaconsole_event_criticity_idx` (`criticity`) ALGORITHM DEFAULT LOCK DEFAULT;
ALTER TABLE `tmetaconsole_event` ADD INDEX `tmetaconsole_event_agent_name_idx` (`agent_name`) ALGORITHM DEFAULT LOCK DEFAULT;
...
ALTER TABLE `tmetaconsole_event_history` ADD INDEX `tmetaconsole_event_history_estado_idx` (`estado`) ALGORITHM DEFAULT LOCK DEFAULT;
ALTER TABLE `tmetaconsole_event_history` ADD INDEX `tmetaconsole_event_history_timestamp_idx` (`timestamp`) ALGORITHM DEFAULT LOCK DEFAULT;
-- ---------------------------------------------------------------------
...
ALTER TABLE `tmetaconsole_agent` ADD COLUMN `remote` tinyint(1) NOT NULL DEFAULT '0',
	...
	ADD INDEX `tmetaconsole_agent_id_os_idx` (`id_os`) ALGORITHM DEFAULT LOCK DEFAULT,
    ADD INDEX `tmetaconsole_agent_server_name_idx` (`server_name`) ALGORITHM DEFAULT LOCK DEFAULT;
