...
$table->data['selection_mode'][1] = __('Select modules first') . ' ' .
	html_print_radio_button_extended ("selection_mode", 'modules', '',
...
$table->data['selection_mode'][3] = __('Select agents first') . ' ' .
	html_print_radio_button_extended ("selection_mode", 'agents', '',
		$selection_mode, false, '', 'style="margin-right: 40px;"', true);
...
$table->data['form_agents_4'][0] .='<span id="agent_loading" class="invisible">';
$table->data['form_agents_4'][0] .= html_print_image('images/spinner.png', true);
$table->data['form_agents_4'][0] .= '</span>';
$table->data['form_agents_4'][1] = html_print_select ($all_agents,
	'id_agents[]', 0, false, '', '', true, true);

$table->data['form_agents_4'][2] = __('When select agents');
$table->data['form_agents_4'][2] .= '<br>';
$table->data['form_agents_4'][2] .= html_print_select (
