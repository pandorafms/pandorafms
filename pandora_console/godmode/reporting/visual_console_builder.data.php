...
switch ($action) {
	case 'new':
		if (!defined('METACONSOLE')) {
			echo "<form method='post' action='index.php?sec=network&sec2=godmode/reporting/visual_console_builder&tab=" . $activeTab  . "' enctype='multipart/form-data'>";
	...
	case 'save':
		if (!defined('METACONSOLE')) {
			echo "<form method='post' action='index.php?sec=network&sec2=godmode/reporting/visual_console_builder&tab=" . $activeTab  . "&id_visual_console=" . $idVisualConsole . "' enctype='multipart/form-data'>";
