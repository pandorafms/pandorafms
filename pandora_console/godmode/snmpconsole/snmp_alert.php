...
if($duplicate_alert){
	$sql = sprintf ("insert into talert_snmp (
		...
		$description, $alert_type, $source_ip, $custom_value, $oid, $time_threshold,
...
//if (isset ($_GET["update_alert"])) {
	...
	// OID
	echo '<tr id="tr-oid">' .
		'<td class="datos2">' . __('Enterprise String') . ui_print_help_tip (__('Matches substrings. End the string with $ for exact matches.'), true) . '</td>' .
		'<td class="datos2">';
