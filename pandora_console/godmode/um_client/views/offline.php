...
<script type="text/javascript">
    var texts = {
        ...
        'notGoingToInstallUnoficialServerWarning': "<?php echo __('This update does not correspond with next version of %s and is not going to be installed unless patches are allowed. Please enable patches in settings.', get_product_name()); ?>",
        'notGoingToInstallUnoficialWarning': "<?php echo __('This server update does not correspond with current console version and is not going to be installed unless patches are allowed. Please enable patches in settings.'); ?>",
    }
