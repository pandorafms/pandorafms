		...
		if ($is_ajax) {
			...
			if (!empty($result)) {
				...
				<script type="text/javascript">
					...
					var mr_not_accepted = "<?php echo __('Minor release rejected'); ?>\n";
					var mr_cancel = "<?php echo __('These database changes will not apply.'); ?>\n";
					var package_cancel = "<?php echo __('These changes will not apply.'); ?>\n";
					var package_not_accepted = "<?php echo __('Package rejected'); ?>\n";
					...
					var package_error = "<?php echo __('Error in package update'); ?>\n";
					var bad_mr_file = "<?php echo __('Bad MR filename, do you want to apply the package?'); ?>\n";
