...
<div style="padding-left: 30px; width: 150px; float: left; line-height: 17px;">
	<h3>Severidad</h3>
	<?php html_print_image("images/status_sets/default/severity_maintenance.png", false, array("title" => "Maintenance event", "alt" => "Maintenance event")); ?> - Evento de mantenimiento<br>
	<?php html_print_image("images/status_sets/default/severity_informational.png", false, array("title" => "Informational event", "alt" => "Informational event")); ?> - Evento informativo<br>
	<?php html_print_image("images/status_sets/default/severity_normal.png", false, array("title" => "Normal event", "alt" => "Normal event")); ?> - Evento normal<br>
	<?php html_print_image("images/status_sets/default/severity_warning.png", false, array("title" => "Warning event", "alt" => "Warning event")); ?> - Evento de alerta<br>
	<?php html_print_image("images/status_sets/default/severity_critical.png", false, array("title" => "Critical event", "alt" => "Critical event")); ?> - Evento crítico<br>
</div>
