...
<?php html_print_image("images/add.png", false, array("alt" => "Add")); ?>(追加)アイコンをクリックして、追加することも可能です。
</p>
<p>
...
ここでは、再度、<strong>順番の変更</strong> (<?php html_print_image("images/up.png", false, array("alt" => "move up icon")); ?>、<?php html_print_image("images/down.png", false, array("alt" => "move down icon")); ?>)、<strong>削除</strong> (<?php html_print_image("images/cross.png", false, array("alt" => "delete icon")); ?>)、<strong>編集</strong> (<?php html_print_image("images/config.png", false, array("alt" => "edit icon")); ?>) ができます。
</p>
<hr/>
