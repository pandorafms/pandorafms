...
// (c) Wayne Munro, R&OS Ltd, http://www.ros.co.nz/pdf
// Some (minimal) patches from Sancho Lerena, <slerena@gmail.com>, December 2007
...
//        $x1=$x1+$dm;
      ...
      foreach($cols as $colName=>$colTitle){
        ...
        foreach ($lines as $line){
                // ORIGINAL: $line = $this->ezProcessText(utf8_decode($line));
                // Patch by slerena, 9/dic/07 to support utf8 contents
          $line = $this->ezProcessText(utf8_decode($line));
          $start=1;
