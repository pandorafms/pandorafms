...
foreach ($modules as $module) {
	...
	if ($module["id_tipo_modulo"] == 24) { // Log4x
		...
		echo "<a href='javascript:winopeng(\"operation/agentes/stat_win.php?type=$graph_type&period=2419200&id=".$module["id_agente_modulo"]."&label=".base64_encode($graph_label)."&refresh=180000\", \"month_".$win_handle."\")'><img src='images/grafica_m.png' border='0' alt='' /></a>&nbsp;";
