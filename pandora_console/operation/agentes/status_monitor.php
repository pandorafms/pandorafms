...
$SQL = " FROM tagente, tagente_modulo WHERE tagente.id_agente = tagente_modulo.id_agente AND tagente_modulo.id_tipo_modulo in (2, 9, 12, 18, 6, 100) ";
...
$counter = get_db_sql ($SQL_COUNT);
    if ( $counter > $block_size) {
        ...
        $SQL_FINAL .= " LIMIT $offset , ".$block_size;
    }
