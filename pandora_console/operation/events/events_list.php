...
$data[0] .= '<a href="javascript:" onclick="show_load_filter_dialog();">'.html_print_image('images/load.png', true, ['border' => '0', 'title' => __('Load filter'), 'alt' => __('Load filter')]).'</a> &nbsp;';
$data[0] .= '</div>';
