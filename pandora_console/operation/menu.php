...
<?php
    if (give_acl($_SESSION["id_usuario"], 0, "AR")==1) {
		if(isset($_GET["sec2"]) && ereg("estado_grupo",$_GET["sec2"])) {
		...
		if (isset($_GET["sec"]) && $_GET["sec"] == "estado"){
			if(isset($_GET["sec2"]) && ereg("estado_agente",$_GET["sec2"])) {
			...
			if(isset($_GET["sec2"]) && ereg("estado_alertas",$_GET["sec2"])) {
			...
			if(isset($_GET["sec2"]) && ereg("status_monitor",$_GET["sec2"])) {
			...
			if(isset($_GET["sec2"]) && ereg("exportdata",$_GET["sec2"])) {
			...
			if(isset($_GET["sec2"]) && ereg("estadisticas",$_GET["sec2"])) {
	...
	if (give_acl($_SESSION["id_usuario"], 0, "AR")==1) {
		if(isset($_GET["sec2"]) && ereg("view_server",$_GET["sec2"])) {
	...
	if (give_acl($_SESSION["id_usuario"], 0, "IR")==1) {
		if(isset($_GET["sec2"]) && ereg("incident$",$_GET["sec2"])) {
		...
		if (isset($_GET["sec"]) && $_GET["sec"] == "incidencias"){
			if(isset($_GET["sec2"]) && ereg("incident_search",$_GET["sec2"])) {
			...
			if(isset($_GET["sec2"]) && ereg("incident_statistics",$_GET["sec2"])) {
	...
	if (give_acl($_SESSION["id_usuario"], 0, "AR")==1) {
		if(isset($_GET["sec2"]) && ereg("events$",$_GET["sec2"])) {
		...
		if (isset($_GET["sec"]) && $_GET["sec"] == "eventos"){
			if(isset($_GET["sec2"]) && ereg("event_statistics",$_GET["sec2"])) {
		...
		if(isset($_GET["sec2"]) && ereg("user$",$_GET["sec2"])) {
		...
		if (isset($_GET["sec"]) && $_GET["sec"] == "usuarios"){
			if(isset($_GET["sec2"]) && ereg("user_edit",$_GET["sec2"])) {
			...
			if(isset($_GET["sec2"]) && ereg("user_statistics",$_GET["sec2"])) {
		...
		if(isset($_GET["sec2"]) && ereg("snmp_view",$_GET["sec2"])) {
		...
		if (isset($_GET["sec"]) && $_GET["sec"] == "snmpconsole"){
			if(isset($_GET["sec2"]) && ereg("snmp_alert",$_GET["sec2"])) {
		...
		if(isset($_GET["sec2"]) && ereg("message",$_GET["sec2"]) && !isset($_GET["nuevo_g"])) {
