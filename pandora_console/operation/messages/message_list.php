	...
	echo "<tr>";
		echo "<td>";
			echo "<div style='float: right;'>";
				if (!empty($messages)){
					if ($show_sent)
						echo '<form method="post" style="float:right;" action="index.php?sec=message_list&amp;sec2=operation/messages/message_list&show_sent=1&amp;multiple_delete=1">';
					else
						echo '<form method="post" action="index.php?sec=message_list&amp;sec2=operation/messages/message_list&amp;multiple_delete=1">';
