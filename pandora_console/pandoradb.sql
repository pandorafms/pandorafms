...
CREATE TABLE IF NOT EXISTS `tevent_rule` (
	...
	`log_source` text,
	`log_agent` text,
	`operator_agent` text DESC 'Operator for agent',
	`operator_id_usuario` text DESC 'Operator for id_usuario',
	`operator_id_grupo` text DESC 'Operator for id_grupo',
	`operator_evento` text DESC 'Operator for evento',
	`operator_event_type` text DESC 'Operator for event_type',
	`operator_module` text DESC 'Operator for module',
	`operator_alert` text DESC 'Operator for alert',
	`operator_criticity` text DESC 'Operator for criticity',
	`operator_user_comment` text DESC 'Operator for user_comment',
	`operator_id_tag` text DESC 'Operator for id_tag',
	`operator_log_content` text DESC 'Operator for log_content',
	`operator_log_source` text DESC 'Operator for log_source',
