...
class ComposerAutoloaderInitfdecadadce22e6dde51e9535fe4ad7aa
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitfdecadadce22e6dde51e9535fe4ad7aa::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirefdecadadce22e6dde51e9535fe4ad7aa($fileIdentifier, $file);
        }
...
function composerRequirefdecadadce22e6dde51e9535fe4ad7aa($fileIdentifier, $file)
{
