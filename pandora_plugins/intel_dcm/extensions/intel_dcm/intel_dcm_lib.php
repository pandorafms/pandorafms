...
function create_custom_field()
{
    ...
    if (!$result) {
        $result = db_process_sql_insert('tagent_custom_fields', ['name' => 'DCM_Entity_Id', 'display_on_front' => 0]);
    }
...
function create_derated_power_custom_field()
{
    ...
    if (!$result) {
        $result = db_process_sql_insert('tagent_custom_fields', ['name' => 'DCM_Entity_Derated_Power', 'display_on_front' => 0]);
    }
...
function set_dcm_id($id_agent, $id_field, $dcm_id)
{
    ...
    if (!$result) {
        db_process_sql_insert('tagent_custom_data', ['id_field' => $id_field, 'id_agent' => $id_agent, 'description' => $dcm_id]);
    } else {
        db_process_sql_update('tagent_custom_data', ['description' => $dcm_id], "id_field = $id_field AND id_agent = $id_agent");
    }
...
function set_dcm_derated_power($id_agent, $id_field, $derated_power)
{
    ...
    if (!$result) {
        db_process_sql_insert('tagent_custom_data', ['id_field' => $id_field, 'id_agent' => $id_agent, 'description' => $derated_power]);
    } else {
        db_process_sql_update('tagent_custom_data', ['description' => $derated_power], "id_field = $id_field AND id_agent = $id_agent");
    }
