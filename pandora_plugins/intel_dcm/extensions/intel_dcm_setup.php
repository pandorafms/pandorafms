...
// ============================================================================
require_once 'intel_dcm/intel_dcm_lib.php';
...
function main_intel_dcm()
{
    ...
    if ($update) {
        ...
        db_process_sql_update('tconfig', ['value' => $dcm_server], ['token' => 'dcm_server']);

        db_process_sql_update('tconfig', ['value' => $dcm_port], ['token' => 'dcm_port']);
