...
sub pandora_execute_action ($$$$$$$$$;$) {
	...
	if ($alert_mode == 0) {
		$field2 = $alert->{'field2_recovery'} ? $alert->{'field2_recovery'} : ($field2 ? "[RECOVER]" . $field2 : "");
		$field3 = $alert->{'field3_recovery'} ? $alert->{'field3_recovery'} : ($field3 ? "[RECOVER]" . $field3 : "");
		$field4 = $alert->{'field4_recovery'} ? $alert->{'field4_recovery'} : ($field4 ? "[RECOVER]" . $field4 : "");
		$field5 = $alert->{'field5_recovery'} ? $alert->{'field5_recovery'} : ($field5 ? "[RECOVER]" . $field5 : "");
		$field6 = $alert->{'field6_recovery'} ? $alert->{'field6_recovery'} : ($field6 ? "[RECOVER]" . $field6 : "");
		$field7 = $alert->{'field7_recovery'} ? $alert->{'field7_recovery'} : ($field7 ? "[RECOVER]" . $field7 : "");
		$field8 = $alert->{'field8_recovery'} ? $alert->{'field8_recovery'} : ($field8 ? "[RECOVER]" . $field8 : "");
		$field9 = $alert->{'field9_recovery'} ? $alert->{'field9_recovery'} : ($field9 ? "[RECOVER]" . $field9 : "");
		$field10 = $alert->{'field10_recovery'} ? $alert->{'field10_recovery'} : ($field10 ? "[RECOVER]" . $field10 : "");
	}
