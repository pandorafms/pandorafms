...
Requires:           net-snmp net-tools 
Requires:           perl-Mail-Sendmail perl-DBI perl-DBD-mysql perl-NetAddr-IP 
Requires:           perl-Time-Format perl-HTML-Parser perl-XML-Simple perl-Net-Traceroute-PurePerl
